...
```ruby
gem "x-twitter-scraper", git: "https://github.com/stainless-sdks/x-twitter-scraper-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/x-twitter-scraper-ruby' '<path-to-repo>'
```
