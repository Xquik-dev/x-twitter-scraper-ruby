...
module XTwitterScraper
  module Models
    class SearchTweet < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(XTwitterScraper::SearchTweet::Author)) }
      attr_reader :author

      sig { params(author: XTwitterScraper::SearchTweet::Author::OrHash).void }
      attr_writer :author
      ...
      sig do
        params(
          id: String,
          text: String,
          author: XTwitterScraper::SearchTweet::Author::OrHash,
        ...
        override.returns(
          {
            id: String,
            text: String,
            author: XTwitterScraper::SearchTweet::Author,
            bookmark_count: Integer,
            created_at: String,
            is_note_tweet: T::Boolean,
            like_count: Integer,
      ...
      class Author < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::SearchTweet::Author,
              XTwitterScraper::Internal::AnyHash
            )
          end
        ...
        sig do
          override.returns(
            { id: String, name: String, username: String, verified: T::Boolean }
          )
        end
        def to_hash
        end
