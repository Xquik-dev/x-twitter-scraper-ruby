  ...
  module Models
    class StyleUpdateResponse < XTwitterScraper::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            XTwitterScraper::Models::StyleUpdateResponse,
      ...
      sig do
        returns(T::Array[XTwitterScraper::Models::StyleUpdateResponse::Tweet])
      end
      ...
      sig do
        params(
          ...
          tweets:
            T::Array[
              XTwitterScraper::Models::StyleUpdateResponse::Tweet::OrHash
            ],
          x_username: String
        ...
        override.returns(
          {
            ...
            tweet_count: Integer,
            tweets:
              T::Array[XTwitterScraper::Models::StyleUpdateResponse::Tweet],
            x_username: String
          }
        )
      end
      ...
      class Tweet < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::StyleUpdateResponse::Tweet,
              XTwitterScraper::Internal::AnyHash
            )
          end
