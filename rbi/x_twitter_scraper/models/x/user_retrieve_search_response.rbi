    ...
    module X
      class UserRetrieveSearchResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveSearchResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveSearchResponse::User
            ]
          )
        end
        attr_accessor :users
        ...
        sig do
          params(
            ...
            users:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveSearchResponse::User::OrHash
              ]
