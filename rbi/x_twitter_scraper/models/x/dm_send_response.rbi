  ...
  module Models
    module X
      class DmSendResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::DmSendResponse::Account)
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::DmSendResponse::Action::TaggedSymbol
          )
        end
        ...
        sig { returns(XTwitterScraper::Models::X::DmSendResponse::Billing) }
        attr_reader :billing

        sig do
          params(
            billing: XTwitterScraper::Models::X::DmSendResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::DmSendResponse::NextAction)
          )
        end
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig { returns(XTwitterScraper::Models::X::DmSendResponse::Request) }
        attr_reader :request

        sig do
          params(
            request: XTwitterScraper::Models::X::DmSendResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(T.nilable(XTwitterScraper::Models::X::DmSendResponse::Result))
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::DmSendResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(T.nilable(XTwitterScraper::Models::X::DmSendResponse::Target))
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::DmSendResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::DmSendResponse::Billing::OrHash,
            charged: T::Boolean,
            ...
            request:
              XTwitterScraper::Models::X::DmSendResponse::Request::OrHash,
            result:
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::Result::OrHash
              ),
            ...
            status:
              XTwitterScraper::Models::X::DmSendResponse::Status::OrSymbol,
            status_url: String,
            success: T::Boolean,
            target:
              T.nilable(
          ...
          override.returns(
            {
              ...
              result:
                T.nilable(XTwitterScraper::Models::X::DmSendResponse::Result),
              retryable: T::Boolean,
              safe_to_retry: T::Boolean,
              send_dispatched: T::Boolean,
              status:
              ...
              success: T::Boolean,
              target:
                T.nilable(XTwitterScraper::Models::X::DmSendResponse::Target),
              target_id: T.nilable(String),
              terminal: T::Boolean,
              write_action_id: String,
              community_id: String,
        ...
        class Account < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::DmSendResponse::Account,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::Models::X::DmSendResponse::Action)
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::DmSendResponse::Billing,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::DmSendResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::DmSendResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::DmSendResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::DmSendResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::DmSendResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::DmSendResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Request < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::DmSendResponse::Request,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::DmSendResponse::Result,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::DmSendResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::DmSendResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::DmSendResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::Models::X::DmSendResponse::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::DmSendResponse::Target,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::DmSendResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::DmSendResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::DmSendResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
