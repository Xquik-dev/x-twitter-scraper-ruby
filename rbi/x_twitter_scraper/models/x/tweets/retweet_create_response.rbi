      ...
      module Tweets
        class RetweetCreateResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Account
              )
            )
          end
          attr_reader :account
          ...
          sig do
            params(
              account:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Account::OrHash
                )
            ).void
          end
          attr_writer :account
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Action::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing
            )
          end
          attr_reader :billing
          ...
          sig do
            params(
              billing:
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing::OrHash
            ).void
          end
          attr_writer :billing
          ...
          sig do
            params(
              next_action:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::NextAction::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Request
            )
          end
          attr_reader :request
          ...
          sig do
            params(
              request:
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Request::OrHash
            ).void
          end
          attr_writer :request
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Result
              )
            )
          end
          attr_reader :result
          ...
          sig do
            params(
              result:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Result::OrHash
                )
            ).void
          end
          attr_writer :result
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Status::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Target
              )
            )
          end
          attr_reader :target
          ...
          sig do
            params(
              target:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Target::OrHash
                )
            ).void
          end
          attr_writer :target
          ...
          sig do
            params(
              ...
              action:
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Action::OrSymbol,
              billing:
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing::OrHash,
              charged: T::Boolean,
              ...
              status:
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Status::OrSymbol,
              status_url: String,
              success: T::Boolean,
              target:
                T.nilable(
          ...
          module Action
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Action
                )
              end
          ...
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing::Status::TaggedSymbol
              )
            end
            attr_accessor :status
            ...
            sig do
              params(
                ...
                status:
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing::Status::OrSymbol
              ).returns(T.attached_class)
            end
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Billing::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::NextAction::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::NextAction::Type::OrSymbol,
                after_ms: Integer,
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::NextAction::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Result::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Result::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Result::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Target::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                id: String,
                type:
                  XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Target::Type::OrSymbol
              ).returns(T.attached_class)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::RetweetCreateResponse::Target::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
