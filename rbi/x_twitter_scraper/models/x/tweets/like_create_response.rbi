      ...
      module Tweets
        class LikeCreateResponse < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse,
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Account
              )
            )
          end
          attr_reader :account
          ...
          sig do
            params(
              account:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Account::OrHash
                )
            ).void
          end
          attr_writer :account
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              billing:
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::OrHash
            ).void
          end
          attr_writer :billing
          ...
          sig do
            params(
              next_action:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Request
            )
          end
          attr_reader :request
          ...
          sig do
            params(
              request:
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Request::OrHash
            ).void
          end
          attr_writer :request
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result
              )
            )
          end
          attr_reader :result
          ...
          sig do
            params(
              result:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::OrHash
                )
            ).void
          end
          attr_writer :result
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target
              )
            )
          end
          attr_reader :target
          ...
          sig do
            params(
              target:
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::OrHash
                )
            ).void
          end
          attr_writer :target
          ...
          sig do
            params(
              ...
              action:
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action::OrSymbol,
              billing:
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::OrHash,
              charged: T::Boolean,
              ...
              status:
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status::OrSymbol,
              status_url: String,
              success: T::Boolean,
              target:
                T.nilable(
          ...
          module Action
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action
                )
              end
          ...
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status::TaggedSymbol
              )
            end
            attr_accessor :status
            ...
            sig do
              params(
                ...
                status:
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status::OrSymbol
              ).returns(T.attached_class)
            end
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                type:
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type::OrSymbol,
                after_ms: Integer,
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                id: String,
                type:
                  XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type::OrSymbol
              ).returns(T.attached_class)
            end
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
