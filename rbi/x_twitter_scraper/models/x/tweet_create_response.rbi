  ...
  module Models
    module X
      class TweetCreateResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::TweetCreateResponse::Account)
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::TweetCreateResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::TweetCreateResponse::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(XTwitterScraper::Models::X::TweetCreateResponse::Billing)
        end
        attr_reader :billing
        ...
        sig do
          params(
            billing:
              XTwitterScraper::Models::X::TweetCreateResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::TweetCreateResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(XTwitterScraper::Models::X::TweetCreateResponse::Request)
        end
        attr_reader :request
        ...
        sig do
          params(
            request:
              XTwitterScraper::Models::X::TweetCreateResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::TweetCreateResponse::Result)
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::TweetCreateResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::TweetCreateResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::TweetCreateResponse::Target)
          )
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::TweetCreateResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::TweetCreateResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::TweetCreateResponse::Billing::OrHash,
            charged: T::Boolean,
            ...
            status:
              XTwitterScraper::Models::X::TweetCreateResponse::Status::OrSymbol,
            status_url: String,
            success: T::Boolean,
            target:
              T.nilable(
          ...
          override.returns(
            {
              ...
              account:
                T.nilable(
                  XTwitterScraper::Models::X::TweetCreateResponse::Account
                ),
              action:
                XTwitterScraper::Models::X::TweetCreateResponse::Action::TaggedSymbol,
              ...
              result:
                T.nilable(
                  XTwitterScraper::Models::X::TweetCreateResponse::Result
                ),
              retryable: T::Boolean,
              safe_to_retry: T::Boolean,
              send_dispatched: T::Boolean,
              ...
              target:
                T.nilable(
                  XTwitterScraper::Models::X::TweetCreateResponse::Target
                ),
              target_id: T.nilable(String),
              terminal: T::Boolean,
              write_action_id: String,
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::TweetCreateResponse::Action
              )
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::TweetCreateResponse::Billing,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Request < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::TweetCreateResponse::Request,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::TweetCreateResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::TweetCreateResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::TweetCreateResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::TweetCreateResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::TweetCreateResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::TweetCreateResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
