    ...
    module X
      class BookmarkListResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::BookmarkListResponse,
        ...
        sig do
          returns(
            T::Array[XTwitterScraper::Models::X::BookmarkListResponse::Tweet]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::BookmarkListResponse::Tweet::OrHash
              ]
          ...
          override.returns(
            {
              ...
              tweets:
                T::Array[
                  XTwitterScraper::Models::X::BookmarkListResponse::Tweet
                ]
            }
          )
        end
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::BookmarkListResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::BookmarkListResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
