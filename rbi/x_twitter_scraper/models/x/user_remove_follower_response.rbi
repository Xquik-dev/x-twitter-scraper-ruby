    ...
    module X
      class UserRemoveFollowerResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing
          )
        end
        attr_reader :billing
        ...
        sig do
          params(
            billing:
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::UserRemoveFollowerResponse::Request
          )
        end
        attr_reader :request
        ...
        sig do
          params(
            request:
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target
            )
          )
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::OrHash,
            charged: T::Boolean,
            ...
            status:
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status::OrSymbol,
            status_url: String,
            success: T::Boolean,
            target:
              T.nilable(
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action
              )
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
