    ...
    module X
      class TweetGetThreadResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::TweetGetThreadResponse,
        ...
        sig do
          returns(
            T::Array[XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::OrHash
              ]
          ...
          override.returns(
            {
              ...
              tweets:
                T::Array[
                  XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet
                ]
            }
          )
        end
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
