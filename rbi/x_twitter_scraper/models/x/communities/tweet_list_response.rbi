      ...
      module Communities
        class TweetListResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                XTwitterScraper::Models::X::Communities::TweetListResponse::Tweet
              ]
            )
          end
          ...
          sig do
            params(
              ...
              tweets:
                T::Array[
                  XTwitterScraper::Models::X::Communities::TweetListResponse::Tweet::OrHash
                ]
          ...
          class Tweet < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  XTwitterScraper::Models::X::Communities::TweetListResponse::Tweet::Author
                )
              )
            end
            attr_reader :author
            ...
            sig do
              params(
                author:
                  XTwitterScraper::Models::X::Communities::TweetListResponse::Tweet::Author::OrHash
              ).void
            end
            attr_writer :author
