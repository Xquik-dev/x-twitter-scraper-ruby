    ...
    module X
      class TweetGetThreadParams < XTwitterScraper::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::X::TweetGetThreadParams,
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::X::TweetGetThreadParams::Quotes::OrSymbol
            )
          )
        end
        attr_reader :quotes
        ...
        sig do
          params(
            replies: XTwitterScraper::X::TweetGetThreadParams::Replies::OrSymbol
          ).void
        end
        attr_writer :replies
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::X::TweetGetThreadParams::MediaType)
            end
          ...
          IMAGES =
            T.let(
              :images,
              XTwitterScraper::X::TweetGetThreadParams::MediaType::TaggedSymbol
            )
          VIDEOS =
            T.let(
              :videos,
        ...
        module Quotes
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::X::TweetGetThreadParams::Quotes)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::TweetGetThreadParams::Quotes::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Replies
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::X::TweetGetThreadParams::Replies)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::TweetGetThreadParams::Replies::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Retweets
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::X::TweetGetThreadParams::Retweets)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::TweetGetThreadParams::Retweets::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
