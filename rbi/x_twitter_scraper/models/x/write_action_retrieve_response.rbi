    ...
    module X
      class WriteActionRetrieveResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::WriteActionRetrieveResponse::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing
          )
        end
        attr_reader :billing
        ...
        sig do
          params(
            billing:
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::WriteActionRetrieveResponse::Request
          )
        end
        attr_reader :request
        ...
        sig do
          params(
            request:
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target
            )
          )
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing::OrHash,
            charged: T::Boolean,
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Action
              )
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::WriteActionRetrieveResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::WriteActionRetrieveResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
