  ...
  module Models
    module X
      class TweetDetail < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(XTwitterScraper::X::TweetDetail::Article)) }
        attr_reader :article

        sig do
          params(article: XTwitterScraper::X::TweetDetail::Article::OrHash).void
        end
        attr_writer :article
        ...
        sig { returns(T.nilable(XTwitterScraper::X::TweetDetail::Card)) }
        attr_reader :card

        sig { params(card: XTwitterScraper::X::TweetDetail::Card::OrHash).void }
        attr_writer :card

        # Community Note presentation metadata returned by X.
        sig do
          returns(T.nilable(XTwitterScraper::X::TweetDetail::CommunityNote))
        end
        ...
        sig do
          params(
            community_note:
              XTwitterScraper::X::TweetDetail::CommunityNote::OrHash
          ).void
        end
        ...
        sig { returns(T.nilable(XTwitterScraper::X::TweetDetail::Edit)) }
        attr_reader :edit

        sig { params(edit: XTwitterScraper::X::TweetDetail::Edit::OrHash).void }
        attr_writer :edit
        ...
        sig { returns(T.nilable(XTwitterScraper::X::TweetDetail::NoteTweet)) }
        attr_reader :note_tweet

        sig do
          params(
            note_tweet: XTwitterScraper::X::TweetDetail::NoteTweet::OrHash
          ).void
        end
        attr_writer :note_tweet

        # Public place metadata attached to a tweet.
        sig { returns(T.nilable(XTwitterScraper::X::TweetDetail::Place)) }
        attr_reader :place

        sig do
          params(place: XTwitterScraper::X::TweetDetail::Place::OrHash).void
        end
        attr_writer :place
        ...
        sig do
          returns(T.nilable(XTwitterScraper::X::TweetDetail::PreviousCounts))
        end
        ...
        sig do
          params(
            previous_counts:
              XTwitterScraper::X::TweetDetail::PreviousCounts::OrHash
          ).void
        end
        ...
        sig do
          params(
            ...
            text: String,
            view_count: Integer,
            article: XTwitterScraper::X::TweetDetail::Article::OrHash,
            author: XTwitterScraper::X::TweetAuthor::OrHash,
            card: XTwitterScraper::X::TweetDetail::Card::OrHash,
            community_note:
              XTwitterScraper::X::TweetDetail::CommunityNote::OrHash,
            content_disclosure: XTwitterScraper::ContentDisclosure::OrHash,
            ...
            edit: XTwitterScraper::X::TweetDetail::Edit::OrHash,
            ...
            note_tweet: XTwitterScraper::X::TweetDetail::NoteTweet::OrHash,
            place: XTwitterScraper::X::TweetDetail::Place::OrHash,
          ...
          override.returns(
            {
              ...
              text: String,
              view_count: Integer,
              article: XTwitterScraper::X::TweetDetail::Article,
              author: XTwitterScraper::X::TweetAuthor,
              card: XTwitterScraper::X::TweetDetail::Card,
              community_note: XTwitterScraper::X::TweetDetail::CommunityNote,
              content_disclosure: XTwitterScraper::ContentDisclosure,
              conversation_id: String,
              created_at: String,
              display_text_range: T::Array[Integer],
              edit: XTwitterScraper::X::TweetDetail::Edit,
              entities: T::Hash[Symbol, T.anything],
              in_reply_to_id: String,
              in_reply_to_user_id: String,
              in_reply_to_username: String,
              ...
              possibly_sensitive: T::Boolean,
              previous_counts: XTwitterScraper::X::TweetDetail::PreviousCounts,
        ...
        class Article < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::X::TweetDetail::Article,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class Card < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::X::TweetDetail::Card,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class Edit < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::X::TweetDetail::Edit,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class NoteTweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  XTwitterScraper::X::TweetDetail::NoteTweet::RichtextTag
                ]
              )
            )
          end
          ...
          sig do
            params(
              richtext_tags:
                T::Array[
                  XTwitterScraper::X::TweetDetail::NoteTweet::RichtextTag::OrHash
                ]
            ).void
          end
