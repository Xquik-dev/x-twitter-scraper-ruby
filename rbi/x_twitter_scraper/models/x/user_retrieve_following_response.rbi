    ...
    module X
      class UserRetrieveFollowingResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveFollowingResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveFollowingResponse::User
            ]
          )
        end
        attr_accessor :users
        ...
        sig do
          params(
            ...
            users:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveFollowingResponse::User::OrHash
              ]
