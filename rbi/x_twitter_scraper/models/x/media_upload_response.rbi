  ...
  module Models
    module X
      class MediaUploadResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::MediaUploadResponse::Account)
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::MediaUploadResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::MediaUploadResponse::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(XTwitterScraper::Models::X::MediaUploadResponse::Billing)
        end
        attr_reader :billing
        ...
        sig do
          params(
            billing:
              XTwitterScraper::Models::X::MediaUploadResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::MediaUploadResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(XTwitterScraper::Models::X::MediaUploadResponse::Request)
        end
        attr_reader :request
        ...
        sig do
          params(
            request:
              XTwitterScraper::Models::X::MediaUploadResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::MediaUploadResponse::Result)
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::MediaUploadResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::MediaUploadResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(XTwitterScraper::Models::X::MediaUploadResponse::Target)
          )
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::MediaUploadResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::MediaUploadResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::MediaUploadResponse::Billing::OrHash,
            charged: T::Boolean,
            ...
            status:
              XTwitterScraper::Models::X::MediaUploadResponse::Status::OrSymbol,
            status_url: String,
            success: T::Boolean,
            target:
              T.nilable(
          ...
          override.returns(
            {
              ...
              account:
                T.nilable(
                  XTwitterScraper::Models::X::MediaUploadResponse::Account
                ),
              action:
                XTwitterScraper::Models::X::MediaUploadResponse::Action::TaggedSymbol,
              ...
              result:
                T.nilable(
                  XTwitterScraper::Models::X::MediaUploadResponse::Result
                ),
              retryable: T::Boolean,
              safe_to_retry: T::Boolean,
              send_dispatched: T::Boolean,
              ...
              target:
                T.nilable(
                  XTwitterScraper::Models::X::MediaUploadResponse::Target
                ),
              target_id: T.nilable(String),
              terminal: T::Boolean,
              write_action_id: String,
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::MediaUploadResponse::Action
              )
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::MediaUploadResponse::Billing,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Request < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::MediaUploadResponse::Request,
                XTwitterScraper::Internal::AnyHash
              )
            end
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::MediaUploadResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::MediaUploadResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::MediaUploadResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::MediaUploadResponse::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::MediaUploadResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::MediaUploadResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::MediaUploadResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
