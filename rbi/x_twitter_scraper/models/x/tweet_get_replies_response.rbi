  ...
  module Models
    module X
      class TweetGetRepliesResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[XTwitterScraper::Models::X::TweetGetRepliesResponse::Tweet]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::TweetGetRepliesResponse::Tweet::OrHash
              ]
          ...
          override.returns(
            {
              ...
              tweets:
                T::Array[
                  XTwitterScraper::Models::X::TweetGetRepliesResponse::Tweet
                ]
            }
          )
        end
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::TweetGetRepliesResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::TweetGetRepliesResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
