    ...
    module X
      class UserRetrieveMentionsResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveMentionsResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet
            ]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
