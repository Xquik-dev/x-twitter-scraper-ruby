...
module XTwitterScraper
  module Models
    module X
      class TweetGetRetweetersResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::TweetGetRetweetersResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::TweetGetRetweetersResponse::User
            ]
          )
        end
        attr_accessor :users
        ...
        sig do
          params(
            ...
            users:
              T::Array[
                XTwitterScraper::Models::X::TweetGetRetweetersResponse::User::OrHash
              ]
