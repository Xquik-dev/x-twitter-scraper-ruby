    ...
    module X
      class ListRetrieveTweetsResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::ListRetrieveTweetsResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet
            ]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
