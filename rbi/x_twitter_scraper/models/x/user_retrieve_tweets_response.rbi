    ...
    module X
      class UserRetrieveTweetsResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveTweetsResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet
            ]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
