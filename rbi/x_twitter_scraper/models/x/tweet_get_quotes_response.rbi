    ...
    module X
      class TweetGetQuotesResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::TweetGetQuotesResponse,
        ...
        sig do
          returns(
            T::Array[XTwitterScraper::Models::X::TweetGetQuotesResponse::Tweet]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::TweetGetQuotesResponse::Tweet::OrHash
              ]
          ...
          override.returns(
            {
              ...
              tweets:
                T::Array[
                  XTwitterScraper::Models::X::TweetGetQuotesResponse::Tweet
                ]
            }
          )
        end
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::TweetGetQuotesResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::TweetGetQuotesResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
