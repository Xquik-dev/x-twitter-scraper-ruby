      ...
      module UserRetrieveVerifiedFollowersResponse
        ...
        class UserListCoverageResponse < XTwitterScraper::Models::PaginatedUsers
          ...
          sig do
            params(
              diagnostic:
                XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage::TaggedBoolean
              )
            )
          end
          ...
          sig do
            params(
              has_next_page:
                XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage::OrBoolean
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              next_cursor:
                XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor::OrSymbol
            ).void
          end
          ...
          class Diagnostic < XTwitterScraper::Internal::Type::BaseModel
            ...
            sig do
              params(
                ...
                strategies:
                  T::Array[
                    XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::OrHash
                  ],
            ...
            class Strategy < XTwitterScraper::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason::TaggedSymbol
                )
              end
              ...
              sig do
                params(
                  ...
                  pages_fetched: Integer,
                  stop_reason:
                    XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason::OrSymbol,
                  strategy: Integer,
              ...
              module StopReason
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason
                    )
                  end
          ...
          module HasNextPage
            ...
            TaggedBoolean =
              T.type_alias do
                T.all(
                  T::Boolean,
                  XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage
                )
              end
          ...
          module NextCursor
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
