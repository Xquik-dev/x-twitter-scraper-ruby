    ...
    module X
      class UserRetrieveLikesResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveLikesResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveLikesResponse::Tweet
            ]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveLikesResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::UserRetrieveLikesResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::UserRetrieveLikesResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
