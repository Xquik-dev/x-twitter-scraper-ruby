    ...
    module X
      class TweetListResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::TweetListResponse,
        ...
        sig do
          returns(
            T::Array[XTwitterScraper::Models::X::TweetListResponse::Tweet]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::TweetListResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::Models::X::TweetListResponse::Tweet,
                XTwitterScraper::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::TweetListResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::TweetListResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
