    ...
    module X
      class UserRetrieveFollowersResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::UserRetrieveFollowersResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::UserRetrieveFollowersResponse::User
            ]
          )
        end
        attr_accessor :users
        ...
        sig do
          params(
            ...
            users:
              T::Array[
                XTwitterScraper::Models::X::UserRetrieveFollowersResponse::User::OrHash
              ]
