    ...
    module X
      class UserRetrieveMediaParams < XTwitterScraper::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::X::UserRetrieveMediaParams,
        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMediaParams::MediaType
              )
            end
          ...
          IMAGES =
            T.let(
              :images,
              XTwitterScraper::X::UserRetrieveMediaParams::MediaType::TaggedSymbol
            )
          VIDEOS =
            T.let(
              :videos,
        ...
        module Quotes
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, XTwitterScraper::X::UserRetrieveMediaParams::Quotes)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMediaParams::Quotes::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Replies
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMediaParams::Replies
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMediaParams::Replies::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Retweets
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMediaParams::Retweets
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMediaParams::Retweets::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
