    ...
    module X
      class ListRetrieveFollowersResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::ListRetrieveFollowersResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::ListRetrieveFollowersResponse::User
            ]
          )
        end
        attr_accessor :users
        ...
        sig do
          params(
            ...
            users:
              T::Array[
                XTwitterScraper::Models::X::ListRetrieveFollowersResponse::User::OrHash
              ]
