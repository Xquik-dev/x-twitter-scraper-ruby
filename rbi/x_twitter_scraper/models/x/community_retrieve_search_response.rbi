    ...
    module X
      class CommunityRetrieveSearchResponse < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::X::CommunityRetrieveSearchResponse,
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet
            ]
          )
        end
        ...
        sig do
          params(
            ...
            tweets:
              T::Array[
                XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::OrHash
              ]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::Author
              )
            )
          end
          attr_reader :author
          ...
          sig do
            params(
              author:
                XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::Author::OrHash
            ).void
          end
          attr_writer :author
