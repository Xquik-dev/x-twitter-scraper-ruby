        ...
        module MediaType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMentionsParams::MediaType
              )
            end
          ...
          IMAGES =
            T.let(
              :images,
              XTwitterScraper::X::UserRetrieveMentionsParams::MediaType::TaggedSymbol
            )
          VIDEOS =
            T.let(
              :videos,
        ...
        module Quotes
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMentionsParams::Quotes
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMentionsParams::Quotes::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Replies
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMentionsParams::Replies
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMentionsParams::Replies::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
        ...
        module Retweets
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::X::UserRetrieveMentionsParams::Retweets
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INCLUDE =
            T.let(
              :include,
              XTwitterScraper::X::UserRetrieveMentionsParams::Retweets::TaggedSymbol
            )
          EXCLUDE =
            T.let(
              :exclude,
