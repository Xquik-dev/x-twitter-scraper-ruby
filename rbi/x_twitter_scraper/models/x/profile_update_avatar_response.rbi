    ...
    module X
      class ProfileUpdateAvatarResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Account
            )
          )
        end
        attr_reader :account
        ...
        sig do
          params(
            account:
              T.nilable(
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Account::OrHash
              )
          ).void
        end
        attr_writer :account
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing
          )
        end
        attr_reader :billing
        ...
        sig do
          params(
            billing:
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::OrHash
          ).void
        end
        attr_writer :billing
        ...
        sig do
          params(
            next_action:
              T.nilable(
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::OrHash
              )
          ).void
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Request
          )
        end
        attr_reader :request
        ...
        sig do
          params(
            request:
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Request::OrHash
          ).void
        end
        attr_writer :request
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              T.nilable(
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::OrHash
              )
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target
            )
          )
        end
        attr_reader :target
        ...
        sig do
          params(
            target:
              T.nilable(
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::OrHash
              )
          ).void
        end
        attr_writer :target
        ...
        sig do
          params(
            ...
            action:
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action::OrSymbol,
            billing:
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::OrHash,
            charged: T::Boolean,
            ...
            status:
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status::OrSymbol,
            status_url: String,
            success: T::Boolean,
            target:
              T.nilable(
        ...
        module Action
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action
              )
            end
        ...
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status::TaggedSymbol
            )
          end
          attr_accessor :status
          ...
          sig do
            params(
              ...
              status:
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type::OrSymbol,
              after_ms: Integer,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              id: String,
              type:
                XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type::OrSymbol
            ).returns(T.attached_class)
          end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
