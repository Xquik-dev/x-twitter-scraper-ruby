    ...
    class ExtractionEstimateCostParams < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              XTwitterScraper::ExtractionEstimateCostParams::RelationTarget
            ]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            XTwitterScraper::ExtractionEstimateCostParams::Scope::OrSymbol
          )
        )
      end
      attr_reader :scope
      ...
      sig do
        returns(
          T.nilable(
            XTwitterScraper::ExtractionEstimateCostParams::Sort::OrSymbol
          )
        )
      end
      attr_reader :sort
        ...
        returns(
          T.nilable(
            T::Array[
              T.any(
                String,
                XTwitterScraper::ExtractionEstimateCostParams::Target::UnionMember1
              )
            ]
          )
        )
      ...
      module CollectionStrategy
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              XTwitterScraper::ExtractionEstimateCostParams::CollectionStrategy
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        AUTO =
          T.let(
            :auto,
            XTwitterScraper::ExtractionEstimateCostParams::CollectionStrategy::TaggedSymbol
          )
        COMPLETE =
          T.let(
            :complete,
      ...
      module DedupeMode
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              XTwitterScraper::ExtractionEstimateCostParams::DedupeMode
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        NONE =
          T.let(
            :none,
            XTwitterScraper::ExtractionEstimateCostParams::DedupeMode::TaggedSymbol
          )
        FIRST =
          T.let(
            :first,
      ...
      module QueryType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              XTwitterScraper::ExtractionEstimateCostParams::QueryType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        LATEST =
          T.let(
            :Latest,
            XTwitterScraper::ExtractionEstimateCostParams::QueryType::TaggedSymbol
          )
        TOP =
          T.let(
            :Top,
      ...
      class RelationTarget < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            XTwitterScraper::ExtractionEstimateCostParams::RelationTarget::Relation::OrSymbol
          )
        end
        ...
        module Relation
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::ExtractionEstimateCostParams::RelationTarget::Relation
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          COMMUNITY_MEMBERS =
            T.let(
              :community_members,
              XTwitterScraper::ExtractionEstimateCostParams::RelationTarget::Relation::TaggedSymbol
            )
          FOLLOWERS =
            T.let(
              :followers,
      ...
      module Scope
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, XTwitterScraper::ExtractionEstimateCostParams::Scope)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        ALL =
          T.let(
            :all,
            XTwitterScraper::ExtractionEstimateCostParams::Scope::TaggedSymbol
          )
        DIRECT =
          T.let(
            :direct,
      ...
      module Sort
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, XTwitterScraper::ExtractionEstimateCostParams::Sort)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        RELEVANCE =
          T.let(
            :relevance,
            XTwitterScraper::ExtractionEstimateCostParams::Sort::TaggedSymbol
          )
        LATEST =
          T.let(
            :latest,
      ...
      module Target
        ...
        class UnionMember1 < XTwitterScraper::Internal::Type::BaseModel
          ...
          sig do
            returns(
              XTwitterScraper::ExtractionEstimateCostParams::Target::UnionMember1::Kind::OrSymbol
            )
          end
          attr_accessor :kind
          ...
          module Kind
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  XTwitterScraper::ExtractionEstimateCostParams::Target::UnionMember1::Kind
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            FAVORITERS =
              T.let(
                :favoriters,
                XTwitterScraper::ExtractionEstimateCostParams::Target::UnionMember1::Kind::TaggedSymbol
              )
            LIST =
              T.let(
                :list,
        ...
        sig do
          override.returns(
            T::Array[
              XTwitterScraper::ExtractionEstimateCostParams::Target::Variants
            ]
          )
        end
        def self.variants
