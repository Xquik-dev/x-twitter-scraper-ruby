  ...
  module Models
    class IntegrationListResponse < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T::Array[
            XTwitterScraper::Models::IntegrationListResponse::Integration
          ]
        )
      end
      ...
      sig do
        params(
          integrations:
            T::Array[
              XTwitterScraper::Models::IntegrationListResponse::Integration::OrHash
            ]
      ...
      class Integration < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[
              XTwitterScraper::Models::IntegrationListResponse::Integration::EventType::TaggedSymbol
            ]
          )
        end
        ...
        sig do
          returns(
            XTwitterScraper::Models::IntegrationListResponse::Integration::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            ...
            event_types:
              T::Array[
                XTwitterScraper::Models::IntegrationListResponse::Integration::EventType::OrSymbol
              ],
            is_active: T::Boolean,
            name: String,
            type:
              XTwitterScraper::Models::IntegrationListResponse::Integration::Type::OrSymbol,
        ...
        module EventType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::IntegrationListResponse::Integration::EventType
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Models::IntegrationListResponse::Integration::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
