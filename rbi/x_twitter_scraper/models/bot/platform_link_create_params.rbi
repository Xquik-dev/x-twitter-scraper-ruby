    ...
    module Bot
      class PlatformLinkCreateParams < XTwitterScraper::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Bot::PlatformLinkCreateParams,
        ...
        module Platform
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                XTwitterScraper::Bot::PlatformLinkCreateParams::Platform
              )
            end
          ...
          TELEGRAM =
            T.let(
              :telegram,
              XTwitterScraper::Bot::PlatformLinkCreateParams::Platform::TaggedSymbol
            )
