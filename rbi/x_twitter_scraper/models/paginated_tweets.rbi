...
module XTwitterScraper
  module Models
    class PaginatedTweets < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig { returns(T::Array[XTwitterScraper::PaginatedTweets::Tweet]) }
      ...
      sig do
        params(
          ...
          next_cursor: String,
          tweets: T::Array[XTwitterScraper::PaginatedTweets::Tweet::OrHash]
        ...
        override.returns(
          {
            has_next_page: T::Boolean,
            next_cursor: String,
            tweets: T::Array[XTwitterScraper::PaginatedTweets::Tweet]
          }
        )
      end
      def to_hash
      ...
      class Tweet < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::PaginatedTweets::Tweet,
              XTwitterScraper::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(T.nilable(XTwitterScraper::PaginatedTweets::Tweet::Author))
        end
        attr_reader :author
        ...
        class Author < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::PaginatedTweets::Tweet::Author,
                XTwitterScraper::Internal::AnyHash
              )
            end
