  ...
  module Models
    class XGetHomeTimelineResponse < XTwitterScraper::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            XTwitterScraper::Models::XGetHomeTimelineResponse,
      ...
      sig do
        returns(
          T::Array[XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet]
        )
      end
      ...
      sig do
        params(
          ...
          tweets:
            T::Array[
              XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::OrHash
            ]
      ...
      class Tweet < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet,
              XTwitterScraper::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::Author
            )
          )
        end
        attr_reader :author
        ...
        sig do
          params(
            author:
              XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::Author::OrHash
          ).void
        end
        attr_writer :author
