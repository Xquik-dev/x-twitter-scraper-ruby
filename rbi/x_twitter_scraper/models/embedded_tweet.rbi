...
module XTwitterScraper
  module Models
    class EmbeddedTweet < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::Article)) }
      attr_reader :article

      sig do
        params(article: XTwitterScraper::EmbeddedTweet::Article::OrHash).void
      end
      attr_writer :article
      ...
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::Card)) }
      attr_reader :card

      sig { params(card: XTwitterScraper::EmbeddedTweet::Card::OrHash).void }
      attr_writer :card

      # Community Note presentation metadata returned by X.
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::CommunityNote)) }
      attr_reader :community_note

      sig do
        params(
          community_note: XTwitterScraper::EmbeddedTweet::CommunityNote::OrHash
        ).void
      end
      ...
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::Edit)) }
      attr_reader :edit

      sig { params(edit: XTwitterScraper::EmbeddedTweet::Edit::OrHash).void }
      attr_writer :edit
      ...
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::NoteTweet)) }
      attr_reader :note_tweet

      sig do
        params(
          note_tweet: XTwitterScraper::EmbeddedTweet::NoteTweet::OrHash
        ).void
      end
      attr_writer :note_tweet

      # Public place metadata attached to a tweet.
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::Place)) }
      attr_reader :place

      sig { params(place: XTwitterScraper::EmbeddedTweet::Place::OrHash).void }
      attr_writer :place
      ...
      sig { returns(T.nilable(XTwitterScraper::EmbeddedTweet::PreviousCounts)) }
      attr_reader :previous_counts

      sig do
        params(
          previous_counts:
            XTwitterScraper::EmbeddedTweet::PreviousCounts::OrHash
        ).void
      end
      ...
      sig { params(quoted_tweet: XTwitterScraper::EmbeddedTweet).void }
      ...
      sig { params(retweeted_tweet: XTwitterScraper::EmbeddedTweet).void }
      ...
      sig do
        params(
          ...
          text: String,
          view_count: Integer,
          article: XTwitterScraper::EmbeddedTweet::Article::OrHash,
          author: XTwitterScraper::UserProfile::OrHash,
          card: XTwitterScraper::EmbeddedTweet::Card::OrHash,
          community_note: XTwitterScraper::EmbeddedTweet::CommunityNote::OrHash,
          content_disclosure: XTwitterScraper::ContentDisclosure::OrHash,
          conversation_id: String,
          created_at: String,
          display_text_range: T::Array[Integer],
          edit: XTwitterScraper::EmbeddedTweet::Edit::OrHash,
          ...
          note_tweet: XTwitterScraper::EmbeddedTweet::NoteTweet::OrHash,
          place: XTwitterScraper::EmbeddedTweet::Place::OrHash,
        ...
        override.returns(
          {
            ...
            text: String,
            view_count: Integer,
            article: XTwitterScraper::EmbeddedTweet::Article,
            author: XTwitterScraper::UserProfile,
            card: XTwitterScraper::EmbeddedTweet::Card,
            community_note: XTwitterScraper::EmbeddedTweet::CommunityNote,
            content_disclosure: XTwitterScraper::ContentDisclosure,
            conversation_id: String,
            created_at: String,
            display_text_range: T::Array[Integer],
            edit: XTwitterScraper::EmbeddedTweet::Edit,
            entities: T::Hash[Symbol, T.anything],
            in_reply_to_id: String,
            in_reply_to_user_id: String,
            in_reply_to_username: String,
            ...
            note_tweet: XTwitterScraper::EmbeddedTweet::NoteTweet,
            place: XTwitterScraper::EmbeddedTweet::Place,
            possibly_sensitive: T::Boolean,
            previous_counts: XTwitterScraper::EmbeddedTweet::PreviousCounts,
            quoted_tweet: XTwitterScraper::EmbeddedTweet,
            retweeted_tweet: XTwitterScraper::EmbeddedTweet,
            source: String,
            type: String,
      ...
      class NoteTweet < XTwitterScraper::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[XTwitterScraper::EmbeddedTweet::NoteTweet::RichtextTag]
            )
          )
        end
        ...
        sig do
          params(
            richtext_tags:
              T::Array[
                XTwitterScraper::EmbeddedTweet::NoteTweet::RichtextTag::OrHash
              ]
          ).void
        end
        ...
        class RichtextTag < XTwitterScraper::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                XTwitterScraper::EmbeddedTweet::NoteTweet::RichtextTag,
                XTwitterScraper::Internal::AnyHash
              )
            end
