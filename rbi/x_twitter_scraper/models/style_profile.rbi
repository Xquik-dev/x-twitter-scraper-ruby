...
module XTwitterScraper
  module Models
    class StyleProfile < XTwitterScraper::Internal::Type::BaseModel
      ...
      sig { returns(T::Array[XTwitterScraper::StyleProfile::Tweet]) }
      ...
      sig do
        params(
          ...
          tweet_count: Integer,
          tweets: T::Array[XTwitterScraper::StyleProfile::Tweet::OrHash],
          x_username: String
        ...
        override.returns(
          {
            ...
            is_own_account: T::Boolean,
            tweet_count: Integer,
            tweets: T::Array[XTwitterScraper::StyleProfile::Tweet],
            x_username: String
          }
        )
      end
      ...
      class Tweet < XTwitterScraper::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              XTwitterScraper::StyleProfile::Tweet,
              XTwitterScraper::Internal::AnyHash
            )
          end
