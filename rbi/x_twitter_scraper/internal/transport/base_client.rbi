      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    XTwitterScraper::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              req:
                XTwitterScraper::Internal::Transport::BaseClient::RequestComponents
            ).void
          end
          def validate!(req)
          end
          ...
          sig do
            params(
              request:
                XTwitterScraper::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status:
                T.any(Integer, XTwitterScraper::Errors::APIConnectionError),
        ...
        # @api private
        sig do
          returns(XTwitterScraper::Internal::Transport::PooledNetRequester)
        end
        ...
        sig do
          overridable
            .params(
              req:
                XTwitterScraper::Internal::Transport::BaseClient::RequestComponents,
              opts: XTwitterScraper::Internal::AnyHash
            )
            .returns(
              XTwitterScraper::Internal::Transport::BaseClient::RequestInput
            )
