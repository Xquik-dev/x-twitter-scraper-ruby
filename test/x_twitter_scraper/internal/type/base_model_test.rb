...
class XTwitterScraper::Test::PrimitiveModelTest < Minitest::Test
  A = XTwitterScraper::Internal::Type::ArrayOf[-> { Integer }]
  H = XTwitterScraper::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < XTwitterScraper::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => XTwitterScraper::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [XTwitterScraper::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [XTwitterScraper::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [XTwitterScraper::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = XTwitterScraper::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        XTwitterScraper::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [XTwitterScraper::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [XTwitterScraper::Internal::Type::Boolean, true] => true,
      [XTwitterScraper::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => XTwitterScraper::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        XTwitterScraper::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = XTwitterScraper::Internal::Type::Converter.new_coerce_state
      XTwitterScraper::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        XTwitterScraper::Internal::Type::Converter.dump(target, input, state: state)
...
class XTwitterScraper::Test::EnumModelTest < Minitest::Test
  class E0
    include XTwitterScraper::Internal::Type::Enum
...
class XTwitterScraper::Test::CollectionModelTest < Minitest::Test
  A1 = XTwitterScraper::Internal::Type::ArrayOf[-> { Integer }]
  H1 = XTwitterScraper::Internal::Type::HashOf[Integer]

  A2 = XTwitterScraper::Internal::Type::ArrayOf[H1]
  H2 = XTwitterScraper::Internal::Type::HashOf[-> { A1 }]

  A3 = XTwitterScraper::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = XTwitterScraper::Internal::Type::HashOf[Integer, nil?: true]
...
class XTwitterScraper::Test::BaseModelTest < Minitest::Test
  class M1 < XTwitterScraper::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < XTwitterScraper::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < XTwitterScraper::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, XTwitterScraper::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = XTwitterScraper::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = XTwitterScraper::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(XTwitterScraper::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue XTwitterScraper::Errors::ConversionError => e
...
class XTwitterScraper::Test::UnionTest < Minitest::Test
  class U0
    include XTwitterScraper::Internal::Type::Union
  ...
  class M2 < XTwitterScraper::Internal::Type::BaseModel
  ...
  class M4 < XTwitterScraper::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, XTwitterScraper::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < XTwitterScraper::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, XTwitterScraper::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class XTwitterScraper::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include XTwitterScraper::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [XTwitterScraper::Internal::Type::Unknown, XTwitterScraper::Internal::Type::Unknown] => true,
      [XTwitterScraper::Internal::Type::Boolean, XTwitterScraper::Internal::Type::Boolean] => true,
      [XTwitterScraper::Internal::Type::Unknown, XTwitterScraper::Internal::Type::Boolean] => false,
...
class XTwitterScraper::Test::MetaInfoTest < Minitest::Test
  A1 = XTwitterScraper::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = XTwitterScraper::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
