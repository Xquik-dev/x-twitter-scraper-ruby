...
class XTwitterScraper::Test::Resources::X::WriteActionsTest < XTwitterScraper::Test::ResourceTest
  def test_retrieve
    ...
    assert_pattern do
      response => {
        id: String,
        account: XTwitterScraper::Models::X::WriteActionRetrieveResponse::Account | nil,
        ...
        next_action: XTwitterScraper::Models::X::WriteActionRetrieveResponse::NextAction | nil,
        object: Symbol,
        poll_after_ms: Integer | nil,
        request: XTwitterScraper::Models::X::WriteActionRetrieveResponse::Request,
        result: XTwitterScraper::Models::X::WriteActionRetrieveResponse::Result | nil,
        ...
        target: XTwitterScraper::Models::X::WriteActionRetrieveResponse::Target | nil,
