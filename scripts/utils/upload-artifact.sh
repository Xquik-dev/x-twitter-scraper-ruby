...
echo -e "\033[32mInstallation: bundle remove x-twitter-scraper && bundle add x-twitter-scraper --source 'https://pkg.stainless.com/s/x-twitter-scraper-ruby/$SHA'\033[0m"
