...
module XTwitterScraper
  module Models
    ...
    class StyleProfile < XTwitterScraper::Internal::Type::BaseModel
      ...
      # @!attribute tweets
      #
      #   @return [Array<XTwitterScraper::Models::StyleProfile::Tweet>]
      required :tweets, -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::StyleProfile::Tweet] }
      ...
      #   @param tweets [Array<XTwitterScraper::Models::StyleProfile::Tweet>]
