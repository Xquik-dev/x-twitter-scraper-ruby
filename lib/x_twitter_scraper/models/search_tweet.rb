...
module XTwitterScraper
  module Models
    class SearchTweet < XTwitterScraper::Internal::Type::BaseModel
      ...
      # @!attribute author
      #
      #   @return [XTwitterScraper::Models::SearchTweet::Author, nil]
      optional :author, -> { XTwitterScraper::SearchTweet::Author }
      ...
      #   @param text [String]
      #
      #   @param author [XTwitterScraper::Models::SearchTweet::Author]
      #
      ...
      # @see XTwitterScraper::Models::SearchTweet#author
