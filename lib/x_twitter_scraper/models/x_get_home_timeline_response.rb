...
module XTwitterScraper
  module Models
    ...
    class XGetHomeTimelineResponse < XTwitterScraper::Internal::Type::BaseModel
      ...
      # @!attribute tweets
      #
      #   @return [Array<XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet>]
      required :tweets,
               -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet] }

      # @!method initialize(has_next_page:, next_cursor:, tweets:)
      #   @param has_next_page [Boolean]
      #   @param next_cursor [String]
      #   @param tweets [Array<XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet>]
      ...
      class Tweet < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute author
        #
        #   @return [XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::Author, nil]
        optional :author, -> { XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::Author }
        ...
        #   @param text [String]
        #
        #   @param author [XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet::Author]
        #
        ...
        # @see XTwitterScraper::Models::XGetHomeTimelineResponse::Tweet#author
