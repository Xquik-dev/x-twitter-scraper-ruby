    ...
    module X
      module Tweets
        ...
        class LikeDeleteResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing]
          required :billing, -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction, nil]
          required :next_action,
                   -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction },
                   api_name: :nextAction,
                   nil?: true
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Request]
          required :request, -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Request }

          # @!attribute result
          #   Confirmed result produced by the write, when available.
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Status }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Tweets::LikeDeleteResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Status]
          #
          #   @param status_url [String]
          #
          #   @param success [Boolean]
          #
          #   @param target [XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#account
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing::Status]
            required :status, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing::Status }
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#request
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Tweets::LikeDeleteResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
