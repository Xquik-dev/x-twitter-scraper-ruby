    ...
    module X
      module Tweets
        ...
        class RetweetDeleteResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing]
          required :billing, -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction, nil]
          required :next_action,
                   -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction },
                   api_name: :nextAction,
                   nil?: true
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Request]
          required :request, -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Request }

          # @!attribute result
          #   Confirmed result produced by the write, when available.
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Status }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Status]
          #
          #   @param status_url [String]
          #
          #   @param success [Boolean]
          #
          #   @param target [XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#account
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing::Status]
            required :status, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing::Status }
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#request
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Tweets::RetweetDeleteResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
