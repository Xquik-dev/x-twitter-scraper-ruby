    ...
    module X
      module Tweets
        ...
        class LikeCreateResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing]
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction, nil]
          required :next_action,
                   -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction },
                   api_name: :nextAction,
                   nil?: true
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Request]
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Tweets::LikeCreateResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Status]
          #
          #   @param status_url [String]
          #
          #   @param success [Boolean]
          #
          #   @param target [XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#account
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status]
            required :status, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status }
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#request
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Tweets::LikeCreateResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
