...
module XTwitterScraper
  module Models
    module X
      ...
      class CommunityRetrieveModeratorsResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::CommunityRetrieveModeratorsResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::CommunityRetrieveModeratorsResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::CommunityRetrieveModeratorsResponse::User>]
