...
module XTwitterScraper
  module Models
    module X
      ...
      class ProfileUpdateAvatarResponse < XTwitterScraper::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::ProfileUpdateAvatarResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#account
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#request
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result::Type]

          # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target::Type]

          # @see XTwitterScraper::Models::X::ProfileUpdateAvatarResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
