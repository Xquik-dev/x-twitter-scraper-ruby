...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveMentionsResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::UserRetrieveMentionsResponse::Tweet#author
