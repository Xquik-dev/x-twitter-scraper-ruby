  ...
  module Models
    module X
      ...
      class TweetListResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::TweetListResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::TweetListResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::TweetListResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::TweetListResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::TweetListResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::TweetListResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::TweetListResponse::Tweet#author
