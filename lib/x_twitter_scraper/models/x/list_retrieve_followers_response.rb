...
module XTwitterScraper
  module Models
    module X
      # @see XTwitterScraper::Resources::X::Lists#retrieve_followers
      class ListRetrieveFollowersResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::ListRetrieveFollowersResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::ListRetrieveFollowersResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::ListRetrieveFollowersResponse::User>]
