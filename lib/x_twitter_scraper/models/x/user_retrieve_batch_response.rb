  ...
  module Models
    module X
      ...
      class UserRetrieveBatchResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveBatchResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveBatchResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveBatchResponse::User>]
