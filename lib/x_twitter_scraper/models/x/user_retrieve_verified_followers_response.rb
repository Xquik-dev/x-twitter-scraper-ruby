...
module XTwitterScraper
  module Models
    module X
      ...
      #
      # @see XTwitterScraper::Resources::X::Users#retrieve_verified_followers
      module UserRetrieveVerifiedFollowersResponse
        ...
        # Paginated user profiles. No-mode follower, following, and verified follower requests merge independent views automatically. Response fields, page size, aliases, filters, and per-returned-profile billing stay unchanged. Existing unprefixed cursors retain legacy behavior. Follow next_cursor while has_next_page is true.
        variant -> { XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse }
        ...
        class UserListCoverageResponse < XTwitterScraper::Models::PaginatedUsers
          ...
          #
          #   @return [XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic]
          required :diagnostic,
                   -> { XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic }

          # @!attribute has_next_page
          #
          #   @return [Boolean, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage, nil]
          optional :has_next_page,
                   enum: -> { XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage }

          # @!attribute next_cursor
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor, nil]
          optional :next_cursor,
                   enum: -> { XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor }
          ...
          #   has_next_page is true.
          #
          #   @param diagnostic [XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic] Coverage evidence across parallel relationship strategies.
          #
          #   @param has_next_page [Boolean, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::HasNextPage]
          #
          #   @param next_cursor [Symbol, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::NextCursor]
          ...
          class Diagnostic < XTwitterScraper::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy>]
            required :strategies,
                     -> do
                       XTwitterScraper::Internal::Type::ArrayOf[
                         XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy
                       ]
                     end
            ...
            #
            #   @param strategies [Array<XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy>]
            #
            ...
            class Strategy < XTwitterScraper::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason]
              required :stop_reason,
                       enum: -> { XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason },
                       api_name: :stopReason
              ...
              #   @param duplicate_count [Integer]
              #   @param pages_fetched [Integer]
              #   @param stop_reason [Symbol, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy::StopReason]
              #   @param strategy [Integer]
              #   @param unique_added [Integer]

              # @see XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy#stop_reason
              module StopReason
        ...
        #   @return [Array(XTwitterScraper::Models::PaginatedUsers, XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::UserListCoverageResponse)]
      end
    end
  end
end
