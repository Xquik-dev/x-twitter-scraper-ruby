...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveVerifiedFollowersResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveVerifiedFollowersResponse::User>]
