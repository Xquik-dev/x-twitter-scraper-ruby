...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveMediaParams < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveMediaParams::MediaType, nil]
        optional :media_type, enum: -> { XTwitterScraper::X::UserRetrieveMediaParams::MediaType }
        ...
        #   Quote mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveMediaParams::Quotes, nil]
        optional :quotes, enum: -> { XTwitterScraper::X::UserRetrieveMediaParams::Quotes }
        ...
        #   Reply mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveMediaParams::Replies, nil]
        optional :replies, enum: -> { XTwitterScraper::X::UserRetrieveMediaParams::Replies }

        # @!attribute retweets
        #   Retweet mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveMediaParams::Retweets, nil]
        optional :retweets, enum: -> { XTwitterScraper::X::UserRetrieveMediaParams::Retweets }
