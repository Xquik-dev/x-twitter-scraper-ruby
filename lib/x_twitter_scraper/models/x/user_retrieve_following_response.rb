...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveFollowingResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveFollowingResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveFollowingResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveFollowingResponse::User>]
