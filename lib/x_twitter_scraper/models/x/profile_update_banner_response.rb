...
module XTwitterScraper
  module Models
    module X
      ...
      class ProfileUpdateBannerResponse < XTwitterScraper::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::ProfileUpdateBannerResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#account
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#request
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result::Type]

          # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target::Type]

          # @see XTwitterScraper::Models::X::ProfileUpdateBannerResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
