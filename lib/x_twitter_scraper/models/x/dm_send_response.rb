  ...
  module Models
    module X
      ...
      class DmSendResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::DmSendResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::DmSendResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::DmSendResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::DmSendResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::DmSendResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::DmSendResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::DmSendResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::DmSendResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::DmSendResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::DmSendResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::DmSendResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::DmSendResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::DmSendResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::DmSendResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::DmSendResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::DmSendResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::DmSendResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::DmSendResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#account
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::DmSendResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::DmSendResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::DmSendResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::DmSendResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::DmSendResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::DmSendResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#request
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::DmSendResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::DmSendResponse::Result::Type]

          # @see XTwitterScraper::Models::X::DmSendResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::DmSendResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::DmSendResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::DmSendResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::DmSendResponse::Target::Type]

          # @see XTwitterScraper::Models::X::DmSendResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
