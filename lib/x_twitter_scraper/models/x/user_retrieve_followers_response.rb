  ...
  module Models
    module X
      ...
      module UserRetrieveFollowersResponse
        ...
        # Paginated user profiles. No-mode follower, following, and verified follower requests merge independent views automatically. Response fields, page size, aliases, filters, and per-returned-profile billing stay unchanged. Existing unprefixed cursors retain legacy behavior. Follow next_cursor while has_next_page is true.
        variant -> { XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse }
        ...
        class UserListCoverageResponse < XTwitterScraper::Models::PaginatedUsers
          ...
          #
          #   @return [XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic]
          required :diagnostic,
                   -> { XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic }

          # @!attribute has_next_page
          #
          #   @return [Boolean, XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::HasNextPage, nil]
          ...
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::NextCursor, nil]
          ...
          #   has_next_page is true.
          #
          #   @param diagnostic [XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic] Coverage evidence across parallel relationship strategies.
          #
          #   @param has_next_page [Boolean, XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::HasNextPage]
          #
          #   @param next_cursor [Symbol, XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::NextCursor]
          ...
          class Diagnostic < XTwitterScraper::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy>]
            required :strategies,
                     -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy] }
            ...
            #
            #   @param strategies [Array<XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse::Diagnostic::Strategy>]
            #
        ...
        #   @return [Array(XTwitterScraper::Models::PaginatedUsers, XTwitterScraper::Models::X::UserRetrieveFollowersResponse::UserListCoverageResponse)]
      end
    end
  end
end
