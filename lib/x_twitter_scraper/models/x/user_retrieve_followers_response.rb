...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveFollowersResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveFollowersResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveFollowersResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveFollowersResponse::User>]
