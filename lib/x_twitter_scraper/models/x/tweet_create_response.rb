  ...
  module Models
    module X
      ...
      class TweetCreateResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::TweetCreateResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::TweetCreateResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::TweetCreateResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::NextAction, nil]
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::TweetCreateResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::TweetCreateResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Status]
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetCreateResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::TweetCreateResponse::Target }, nil?: true
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::TweetCreateResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::TweetCreateResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::TweetCreateResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::TweetCreateResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::TweetCreateResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param target [XTwitterScraper::Models::X::TweetCreateResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#account
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::TweetCreateResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::TweetCreateResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#request
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::TweetCreateResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Result::Type]

          # @see XTwitterScraper::Models::X::TweetCreateResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetCreateResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::TweetCreateResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetCreateResponse::Target::Type]

          # @see XTwitterScraper::Models::X::TweetCreateResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
