...
module XTwitterScraper
  module Models
    module X
      # @see XTwitterScraper::Resources::X::Users#remove_follower
      class UserRemoveFollowerResponse < XTwitterScraper::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction, nil]
        ...
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::UserRemoveFollowerResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#account
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#request
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result::Type]

          # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target::Type]

          # @see XTwitterScraper::Models::X::UserRemoveFollowerResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
