    ...
    module X
      module Communities
        ...
        class JoinCreateResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing]
          required :billing, -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction, nil]
          ...
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Request]
          required :request, -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Request }

          # @!attribute result
          #   Confirmed result produced by the write, when available.
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Status }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Communities::JoinCreateResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param status [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Status]
          #
          #   @param status_url [String]
          #
          #   @param success [Boolean]
          #
          #   @param target [XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#account
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing::Status]
            required :status,
                     enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing::Status }
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#request
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Communities::JoinCreateResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
