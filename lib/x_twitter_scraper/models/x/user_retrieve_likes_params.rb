  ...
  module Models
    module X
      ...
      class UserRetrieveLikesParams < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveLikesParams::MediaType, nil]
        optional :media_type, enum: -> { XTwitterScraper::X::UserRetrieveLikesParams::MediaType }
        ...
        #   Quote mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveLikesParams::Quotes, nil]
        optional :quotes, enum: -> { XTwitterScraper::X::UserRetrieveLikesParams::Quotes }
        ...
        #   Reply mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveLikesParams::Replies, nil]
        optional :replies, enum: -> { XTwitterScraper::X::UserRetrieveLikesParams::Replies }

        # @!attribute retweets
        #   Retweet mode.
        #
        #   @return [Symbol, XTwitterScraper::Models::X::UserRetrieveLikesParams::Retweets, nil]
        optional :retweets, enum: -> { XTwitterScraper::X::UserRetrieveLikesParams::Retweets }
