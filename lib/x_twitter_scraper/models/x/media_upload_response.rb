  ...
  module Models
    module X
      ...
      class MediaUploadResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::MediaUploadResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::MediaUploadResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::MediaUploadResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::Request]
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::MediaUploadResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::MediaUploadResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::MediaUploadResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::MediaUploadResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::MediaUploadResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::MediaUploadResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::MediaUploadResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::MediaUploadResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::MediaUploadResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::MediaUploadResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#account
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::MediaUploadResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::MediaUploadResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#request
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Result::Type]

          # @see XTwitterScraper::Models::X::MediaUploadResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::MediaUploadResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::MediaUploadResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::MediaUploadResponse::Target::Type]

          # @see XTwitterScraper::Models::X::MediaUploadResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
