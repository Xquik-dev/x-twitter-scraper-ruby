...
module XTwitterScraper
  module Models
    module X
      ...
      class CommunityRetrieveSearchResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::CommunityRetrieveSearchResponse::Tweet#author
