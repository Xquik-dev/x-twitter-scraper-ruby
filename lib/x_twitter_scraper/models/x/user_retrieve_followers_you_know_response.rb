...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveFollowersYouKnowResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveFollowersYouKnowResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveFollowersYouKnowResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveFollowersYouKnowResponse::User>]
