...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveSearchResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveSearchResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveSearchResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::UserRetrieveSearchResponse::User>]
