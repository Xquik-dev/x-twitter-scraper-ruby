...
module XTwitterScraper
  module Models
    module X
      ...
      class TweetGetThreadResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::TweetGetThreadResponse::Tweet#author
