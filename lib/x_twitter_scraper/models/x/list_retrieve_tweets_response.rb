...
module XTwitterScraper
  module Models
    module X
      ...
      class ListRetrieveTweetsResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::ListRetrieveTweetsResponse::Tweet#author
