...
module XTwitterScraper
  module Models
    module X
      ...
      class CommunityDeleteResponse < XTwitterScraper::Internal::Type::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::CommunityDeleteResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::CommunityDeleteResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::CommunityDeleteResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::CommunityDeleteResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::CommunityDeleteResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::CommunityDeleteResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::CommunityDeleteResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#account
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::CommunityDeleteResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::CommunityDeleteResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#request
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Result::Type]

          # @see XTwitterScraper::Models::X::CommunityDeleteResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::CommunityDeleteResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::CommunityDeleteResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::CommunityDeleteResponse::Target::Type]

          # @see XTwitterScraper::Models::X::CommunityDeleteResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
