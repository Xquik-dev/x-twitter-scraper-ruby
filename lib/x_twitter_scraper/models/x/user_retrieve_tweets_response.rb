...
module XTwitterScraper
  module Models
    module X
      ...
      class UserRetrieveTweetsResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute tweets
        #
        #   @return [Array<XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet>]
        required :tweets,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet] }
        ...
        #   @param tweets [Array<XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet>]
        ...
        class Tweet < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute author
          #
          #   @return [XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::Author, nil]
          optional :author, -> { XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::Author }
          ...
          #   @param text [String]
          #
          #   @param author [XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet::Author]
          #
          ...
          # @see XTwitterScraper::Models::X::UserRetrieveTweetsResponse::Tweet#author
