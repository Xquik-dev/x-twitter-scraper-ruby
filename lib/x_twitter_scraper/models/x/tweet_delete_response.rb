  ...
  module Models
    module X
      ...
      class TweetDeleteResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::Account, nil]
        required :account, -> { XTwitterScraper::Models::X::TweetDeleteResponse::Account }, nil?: true

        # @!attribute action
        #
        #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Action]
        required :action, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::Action }
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::Billing]
        required :billing, -> { XTwitterScraper::Models::X::TweetDeleteResponse::Billing }
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::NextAction, nil]
        required :next_action,
                 -> { XTwitterScraper::Models::X::TweetDeleteResponse::NextAction },
                 api_name: :nextAction,
                 nil?: true
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::Request]
        required :request, -> { XTwitterScraper::Models::X::TweetDeleteResponse::Request }

        # @!attribute result
        #   Confirmed result produced by the write, when available.
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::Result, nil]
        required :result, -> { XTwitterScraper::Models::X::TweetDeleteResponse::Result }, nil?: true
        ...
        # @!attribute status
        #
        #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Status]
        required :status, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::Status }
        ...
        #
        #   @return [XTwitterScraper::Models::X::TweetDeleteResponse::Target, nil]
        required :target, -> { XTwitterScraper::Models::X::TweetDeleteResponse::Target }, nil?: true
        ...
        #   {XTwitterScraper::Models::X::TweetDeleteResponse} for more details.
        #
        ...
        #   @param id [String]
        #
        #   @param account [XTwitterScraper::Models::X::TweetDeleteResponse::Account, nil] Connected account selected for the write.
        #
        #   @param action [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Action]
        #
        #   @param billing [XTwitterScraper::Models::X::TweetDeleteResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
        #
        #   @param charged [Boolean]
        #
        #   @param charged_credits [String]
        #
        #   @param next_action [XTwitterScraper::Models::X::TweetDeleteResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
        #
        #   @param poll_after_ms [Integer, nil]
        #
        #   @param request [XTwitterScraper::Models::X::TweetDeleteResponse::Request] Stable fingerprint and sanitized payload for replay checks.
        #
        #   @param result [XTwitterScraper::Models::X::TweetDeleteResponse::Result, nil] Confirmed result produced by the write, when available.
        #
        ...
        #
        #   @param status [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Status]
        #
        #   @param status_url [String]
        #
        #   @param success [Boolean]
        #
        #   @param target [XTwitterScraper::Models::X::TweetDeleteResponse::Target, nil] Existing X resource targeted by the write, when applicable.
        #
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#account
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#action
        module Action
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#billing
        class Billing < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Billing::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::Billing::Status }
          ...
          #   @param status [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Billing::Status]

          # @see XTwitterScraper::Models::X::TweetDeleteResponse::Billing#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#next_action
        class NextAction < XTwitterScraper::Internal::Type::BaseModel
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::NextAction::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::NextAction::Type }
          ...
          #   Exact follow-up an API client or agent should perform.
          #
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::NextAction::Type]
          #   @param after_ms [Integer]
          #   @param requires_new_idempotency_key [Boolean]
          #   @param url [String]

          # @see XTwitterScraper::Models::X::TweetDeleteResponse::NextAction#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#request
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#result
        class Result < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Result::Type, nil]
          optional :type, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::Result::Type }
          ...
          #   @param id [String]
          #   @param state [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Result::Type]

          # @see XTwitterScraper::Models::X::TweetDeleteResponse::Result#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#status
        module Status
          extend XTwitterScraper::Internal::Type::Enum
        ...
        # @see XTwitterScraper::Models::X::TweetDeleteResponse#target
        class Target < XTwitterScraper::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Target::Type]
          required :type, enum: -> { XTwitterScraper::Models::X::TweetDeleteResponse::Target::Type }

          # @!method initialize(id:, type:)
          #   Existing X resource targeted by the write, when applicable.
          #
          #   @param id [String]
          #   @param type [Symbol, XTwitterScraper::Models::X::TweetDeleteResponse::Target::Type]

          # @see XTwitterScraper::Models::X::TweetDeleteResponse::Target#type
          module Type
            extend XTwitterScraper::Internal::Type::Enum
