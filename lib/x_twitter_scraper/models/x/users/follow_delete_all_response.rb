    ...
    module X
      module Users
        ...
        class FollowDeleteAllResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing]
          required :billing, -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction, nil]
          required :next_action,
                   -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction },
                   api_name: :nextAction,
                   nil?: true
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Request]
          required :request, -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Request }

          # @!attribute result
          #   Confirmed result produced by the write, when available.
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Status]
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Users::FollowDeleteAllResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param target [XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#account
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing::Status]
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#request
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Users::FollowDeleteAllResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
