...
module XTwitterScraper
  module Models
    module X
      module Users
        # @see XTwitterScraper::Resources::X::Users::Follow#create
        class FollowCreateResponse < XTwitterScraper::Internal::Type::BaseModel
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::Account, nil]
          required :account, -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Account }, nil?: true

          # @!attribute action
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Action]
          required :action, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Action }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing]
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction, nil]
          required :next_action,
                   -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction },
                   api_name: :nextAction,
                   nil?: true
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::Request]
          required :request, -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Request }

          # @!attribute result
          #   Confirmed result produced by the write, when available.
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::Result, nil]
          required :result, -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Result }, nil?: true
          ...
          # @!attribute status
          #
          #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Status]
          required :status, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Status }
          ...
          #
          #   @return [XTwitterScraper::Models::X::Users::FollowCreateResponse::Target, nil]
          required :target, -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Target }, nil?: true
          ...
          #   {XTwitterScraper::Models::X::Users::FollowCreateResponse} for more details.
          #
          ...
          #   @param id [String]
          #
          #   @param account [XTwitterScraper::Models::X::Users::FollowCreateResponse::Account, nil] Connected account selected for the write.
          #
          #   @param action [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Action]
          #
          #   @param billing [XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing] plannedCredits is the approved maximum. chargedCredits comes from the settled cr
          #
          #   @param charged [Boolean]
          #
          #   @param charged_credits [String]
          #
          #   @param next_action [XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction, nil] Exact follow-up an API client or agent should perform.
          #
          #   @param poll_after_ms [Integer, nil]
          #
          #   @param request [XTwitterScraper::Models::X::Users::FollowCreateResponse::Request] Stable fingerprint and sanitized payload for replay checks.
          #
          #   @param result [XTwitterScraper::Models::X::Users::FollowCreateResponse::Result, nil] Confirmed result produced by the write, when available.
          #
          ...
          #
          #   @param status [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Status]
          #
          #   @param status_url [String]
          #
          #   @param success [Boolean]
          #
          #   @param target [XTwitterScraper::Models::X::Users::FollowCreateResponse::Target, nil] Existing X resource targeted by the write, when applicable.
          #
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#account
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#action
          module Action
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#billing
          class Billing < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing::Status]
            required :status, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing::Status }
            ...
            #   @param status [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing::Status]

            # @see XTwitterScraper::Models::X::Users::FollowCreateResponse::Billing#status
            module Status
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#next_action
          class NextAction < XTwitterScraper::Internal::Type::BaseModel
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction::Type }
            ...
            #   Exact follow-up an API client or agent should perform.
            #
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction::Type]
            #   @param after_ms [Integer]
            #   @param requires_new_idempotency_key [Boolean]
            #   @param url [String]

            # @see XTwitterScraper::Models::X::Users::FollowCreateResponse::NextAction#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#request
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#result
          class Result < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Result::Type, nil]
            optional :type, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Result::Type }
            ...
            #   @param id [String]
            #   @param state [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Result::Type]

            # @see XTwitterScraper::Models::X::Users::FollowCreateResponse::Result#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#status
          module Status
            extend XTwitterScraper::Internal::Type::Enum
          ...
          # @see XTwitterScraper::Models::X::Users::FollowCreateResponse#target
          class Target < XTwitterScraper::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Target::Type]
            required :type, enum: -> { XTwitterScraper::Models::X::Users::FollowCreateResponse::Target::Type }

            # @!method initialize(id:, type:)
            #   Existing X resource targeted by the write, when applicable.
            #
            #   @param id [String]
            #   @param type [Symbol, XTwitterScraper::Models::X::Users::FollowCreateResponse::Target::Type]

            # @see XTwitterScraper::Models::X::Users::FollowCreateResponse::Target#type
            module Type
              extend XTwitterScraper::Internal::Type::Enum
