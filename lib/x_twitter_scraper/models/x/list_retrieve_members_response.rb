  ...
  module Models
    module X
      ...
      class ListRetrieveMembersResponse < XTwitterScraper::Internal::Type::BaseModel
        ...
        # @!attribute users
        #
        #   @return [Array<XTwitterScraper::Models::X::ListRetrieveMembersResponse::User>]
        required :users,
                 -> { XTwitterScraper::Internal::Type::ArrayOf[XTwitterScraper::Models::X::ListRetrieveMembersResponse::User] }
        ...
        #   @param users [Array<XTwitterScraper::Models::X::ListRetrieveMembersResponse::User>]
