...
module XTwitterScraper
  module Internal
    module Transport
      ...
      # @abstract
      class BaseClient
        extend XTwitterScraper::Internal::Util::SorbetRuntimeSupport
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => XTwitterScraper::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => XTwitterScraper::Internal::Util.os,
            "x-stainless-package-version" => XTwitterScraper::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = XTwitterScraper::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise XTwitterScraper::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if XTwitterScraper::Internal::Util.uri_origin(url) != XTwitterScraper::Internal::Util.uri_origin(location)
          ...
          # @api private
          #
          # @param status [Integer, XTwitterScraper::Errors::APIConnectionError]
          # @param stream [Enumerable<String>, nil]
          def reap_connection!(status, stream:)
            case status
            in (..199) | (300..499)
              stream&.each { next }
            in XTwitterScraper::Errors::APIConnectionError | (500..)
              XTwitterScraper::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        # @api private
        # @return [XTwitterScraper::Internal::Transport::PooledNetRequester]
        ...
        def initialize(
          ...
          @requester = XTwitterScraper::Internal::Transport::PooledNetRequester.new
          ...
          @base_url_components = XTwitterScraper::Internal::Util.parse_uri(base_url)
          @base_url = XTwitterScraper::Internal::Util.unparse_uri(@base_url_components)
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{XTwitterScraper::VERSION}"
        ...
        #
        #   @option req [Class<XTwitterScraper::Internal::Type::BasePage>, nil] :page
        #
        #   @option req [Class<XTwitterScraper::Internal::Type::BaseStream>, nil] :stream
        #
        ...
        private def build_request(req, opts)
          ...
          path = XTwitterScraper::Internal::Util.interpolate_path(uninterpolated_path)

          query = XTwitterScraper::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          headers, encoded = XTwitterScraper::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: url,
            headers: headers,
        ...
        #
        # @raise [XTwitterScraper::Errors::APIError]
        # @return [Array(Integer, Net::HTTPResponse, Enumerable<String>)]
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          url, headers, max_retries, timeout = request.fetch_values(:url, :headers, :max_retries, :timeout)
          input = {**request.except(:timeout), deadline: XTwitterScraper::Internal::Util.monotonic_secs + timeout}
          ...
          headers = XTwitterScraper::Internal::Util.normalized_headers(response&.each_header&.to_h)
          ...
          in XTwitterScraper::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: headers)
            decoded = Kernel.then do
              XTwitterScraper::Internal::Util.decode_content(headers, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end

            raise XTwitterScraper::Errors::APIStatusError.for(
              url: url,
              status: status,
              headers: headers,
              body: decoded,
          ...
          in (400..) | XTwitterScraper::Errors::APIConnectionError
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param page [Class<XTwitterScraper::Internal::Type::BasePage>, nil]
        #
        ...
        def request(req)
          ...
          unwrap = req[:unwrap]
          XTwitterScraper::RequestOptions.validate!(opts)
          ...
          headers = XTwitterScraper::Internal::Util.normalized_headers(response.each_header.to_h)
          decoded = XTwitterScraper::Internal::Util.decode_content(headers, stream: stream)
          case req
          in {stream: Class => st}
            st.new(
              model: model,
          ...
          in {page: Class => page}
            ...
            unwrapped = XTwitterScraper::Internal::Util.dig(decoded, unwrap)
            XTwitterScraper::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
